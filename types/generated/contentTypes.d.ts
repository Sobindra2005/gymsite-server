...
export interface ApiExpertTrainerExpertTrainer
  extends Struct.CollectionTypeSchema {
  collectionName: 'expert_trainers';
  info: {
    displayName: 'expertTrainer';
    pluralName: 'expert-trainers';
    singularName: 'expert-trainer';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::expert-trainer.expert-trainer'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiServiceAndFacilityServiceAndFacility
  extends Struct.CollectionTypeSchema {
  collectionName: 'service_and_facilities';
  info: {
    displayName: 'service&Facility';
    pluralName: 'service-and-facilities';
    singularName: 'service-and-facility';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::service-and-facility.service-and-facility'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::expert-trainer.expert-trainer': ApiExpertTrainerExpertTrainer;
      'api::gallery.gallery': ApiGalleryGallery;
      'api::global.global': ApiGlobalGlobal;
      'api::hero-section.hero-section': ApiHeroSectionHeroSection;
      'api::membership.membership': ApiMembershipMembership;
      'api::service-and-facility.service-and-facility': ApiServiceAndFacilityServiceAndFacility;
